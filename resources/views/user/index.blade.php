              ...
              @foreach($users as $user)
                <tr id="{{ $user->id }}">
                  <td style="display: flex; align-items: center;">
                    <button class="btn btn-default mail-btn" onclick="mailUser({{ $user->id }})"><i class="far fa-envelope"></i></button>
                    <button class="btn btn-default edit-btn"><i class="fas fa-edit"></i></button>
                    <button class="btn btn-danger" onclick="deleteUser({{ $user->id }})"><i class="fas fa-trash-alt"></i></button>
                    <button class="btn btn-success update-btn">{{__('Save')}}</button>
                  </td>
                  <td data-title="pwd">{{ $user->orig }}</td>
                  <td data-title="email">{{ $user->email }}</td>
                  <td data-title="name">{{ $user->name }}</td>
                  <td data-title="role" data-roleid="{{ $user->role->id }}">{{ $user->role->title }}</td>
                </tr>
              @endforeach
            </tbody>
          </table>
    ...
    <script>
      ...
      $(".update-btn").on('click', function() {
        ...
        $.ajax({
          ...
          data: {"_token": "{{ csrf_token() }}", "pwd":data.pwd, "email":data.email, "name":data.name, "role":data.role},

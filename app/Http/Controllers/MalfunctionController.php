...
class MalfunctionController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $view_data = compact('malfunction_id', 'malfunction', 'categories', 'paragraphs_total', 'categories_total', 'user', 'date');
    ...
    public function edit($id)
    {
        ...
        $malfunction_model->data = json_encode($malfunction);
        $malfunction_model->save();
        ...
        $view_data = compact('categories', 'malfunction', 'malfunction_id', 'nameCode', 'companies', 'sites', 'subsites', 'score', 'fork', 'risk', 'date', 'user', 'files');
        $view_with_data = [
    ...
    public function ajaxChangeStatus(Request $request) {
        ...
        if($type == 'malfunction') {
            $malfunction = Malfunction::find($id);
            $data = $malfunction->data;
            $data = array_merge($data, array('admin_name' => $admin_name));
        ...
        if($status == 'publish') {
            ...
            $users = User::with(['role'])->leftJoin('roles', 'users.role_id', '=', 'roles.id')
                            ->where('roles.title', '=', 'Contractor')->orWhere('roles.title', '=', 'Client')

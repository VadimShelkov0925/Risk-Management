                ...
                <div class="card-header">
                    <?php if((!isset($malfunction->data['status']) || !isset($malfunction->data['status']['stage']) || $malfunction->data['status']['stage'] != 'publish') && ($user_role == 'admin' || $user_role == 'employee')): ?>
                        <div class="btn-group <?php echo e(app()->getLocale() == 'he' ? 'right' : 'left'); ?>">
                            ...
                            <a class='btn-action' style="color:black;" href="<?php echo e(action('MalfunctionController@edit', $malfunction->id)); ?>">
                                                ...
                                                <table class="table table-striped" border="1" style="margin-bottom: 0px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 0px; text-align: center;">
                                                            <table class="table" style="background: transparent; margin-bottom: 0px;">
                                                                <tr style="background: transparent;">
                                                                    <td style="border-top: 0px; <?php echo e(App::getLocale() == 'he' ? 'border-left: 1px solid grey;' : 'border-right: 1px solid grey;'); ?>"
                                                                        width="20%"><?php echo e(__('TYPE_F')); ?>

                                                                    </td>
                                                                    <td style="border-top: 0px; <?php echo e(App::getLocale() == 'he' ? 'border-left: 1px solid grey;' : 'border-right: 1px solid grey;'); ?>"
                                                                        width="20%"><?php echo e(__('TYPE_S')); ?>

                                                                    </td>
                                                                    <td style="border-top: 0px; <?php echo e(App::getLocale() == 'he' ? 'border-left: 1px solid grey;' : 'border-right: 1px solid grey;'); ?>"
                                                                        width="20%"><?php echo e(__('TYPE_B')); ?>

                                                                    </td>
                                                                    <td style="border-top: 0px; <?php echo e(App::getLocale() == 'he' ? 'border-left: 1px solid grey;' : 'border-right: 1px solid grey;'); ?>"
                                                                        width="20%"><?php echo e(__('TYPE_N')); ?>

                                                                    </td>
                                                                    <td style="border-top: 0px;" width="20%"><?php echo e(__('TYPE_C')); ?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        <td style="padding: 0px;">
                                                            <table class="table" style="background: transparent; margin-bottom: 0px;">
                                                                <tr style="background: transparent;">
                                                                    <td style="border-top: 0px; <?php echo e(App::getLocale() == 'he' ? 'border-left: 1px solid black;' : 'border-right: 1px solid black;'); ?>" width="65%"><?php echo e(__('Relatively')); ?></td>
                                                                    <td style="border-top: 0px;" width="35%"><?php echo e(__('Total')); ?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <?php if(isset($malfunction->data['paragraphs']) && isset($malfunction->data['paragraphs'][$category['id']])): ?>
                                                        <?php $__currentLoopData = $malfunction->data['paragraphs'][$category['id']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph_key => $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><?php echo e(($category_key+1) .'.'. ($paragraph_key+1)); ?> <?php echo e($paragraph['name']); ?></td>
                                                                <td style="padding: 0px; text-align: center;">
                                                                    <table class="table" style="background: transparent; margin-bottom: 0px;">
                                                                        <tr style="background: transparent;">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        var Lang = {
            ...
            "Message sent succusfully" : "<?php echo e(__('Message sent succusfully')); ?>",
